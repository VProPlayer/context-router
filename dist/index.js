...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        ...
        },
        {
            ...
            description: "Generate a custom instructions snippet for Claude.ai chat, tailored to the current project config. " +
    ...
    try {
        switch (name) {
            ...
            case "create_project": {
                ...
                return { content: [{ type: "text", text: createProject(key, project) }] };
            }
            ...
            case "delete_project": {
                ...
                return { content: [{ type: "text", text: deleteProject(key) }] };
            }
            case "read_repo_file": {
